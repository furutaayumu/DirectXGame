...
void GameScene::Update() {
	if (rand() % 20 == 0) {
		Vector3 pos = Vector3(RandomFloat(RandomEngine) * 30.0f, RandomFloat(RandomEngine) * 30.0f, 0);
		Vector4 color = Vector4(distribution(RandomEngine), distribution(RandomEngine), distribution(RandomEngine), 2.0f);
